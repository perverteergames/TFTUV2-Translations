# TODO: Translation updated at 2025-07-20 16:58
...
translate simplified_chinese strings:
    ...
    new "无障碍菜单。使用上下箭头导航，按回车键激活按钮和进度条。"
    ...
    new "本菜单选项旨在提升无障碍体验。可能不适用于所有游戏，部分选项组合可能导致游戏无法运行。此非游戏或引擎问题。更改字体时，建议保持原始文本大小以获得最佳效果。"
    ...
    new "自定义director.transitions以添加更多过渡效果。"
    ...
    new "自定义director.audio_channels以添加更多音频通道。"
    ...
    new "确定要跳过未读对话直达下个选项吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "该存档创建于其他设备。恶意构造的存档文件可能危害您的计算机。您是否信任该存档的创建者及所有可能修改过该文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "您信任创建该存档的设备吗？只有当您是该设备的唯一使用者时，才应选择“是”。"
    ...
    new "本程序包含基于多种许可证(包括MIT许可证和GNU宽松通用公共许可证)的自由软件。完整软件列表及源代码链接请见{a=https://www.renpy.org/l/license}此处{/a}。"
    ...
    new "剪贴板语音已启用。按'shift+C'键禁用。"

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自动语音会播报\"[renpy.display.tts.last]\"。按'alt+shift+V'键禁用。"
    ...
    new "连接Ren'Py同步服务器时发生未知错误。"

    # renpy/common/00sync.rpy:213
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "Ren'Py同步服务器上没有此同步记录。同步ID可能无效或已超时。"
    ...
    new "这将把您的存档上传至{a=https://sync.renpy.org}Ren'Py同步服务器{/a}。\n是否继续？"
    ...
    new "这将连接{a=https://sync.renpy.org}Ren'Py同步服务器{/a}。"
    ...
    new "您可以使用此ID在其他设备下载存档。\n该同步将在一小时后失效。\nRen'Py同步功能由{a=https://www.renpy.org/sponsors.html}Ren'Py赞助者{/a}提供支持。"
    ...
    new "翻译中[tl.filename]：[tl.linenumber]"
